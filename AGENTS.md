...
Для запуска кода на python используй вирутальное окружение .venv. Также передавай эту инструкцию по испольтзованию вирутального окружения суб-агентам при необходимости, чтобы они не пытались запрускать код напрямую. При необходимости установки новых python-модулей, тикже вызывай pip внутри вирутального окружения.
