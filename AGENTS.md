...
Для получения актуальной документации библиотек и фреймворков проекта (FastAPI, Pydantic, asyncpg, httpx, pytest и др.) используй MCP-сервер context7. Доступны инструменты: context7_resolve-library-id и context7_query-docs.
