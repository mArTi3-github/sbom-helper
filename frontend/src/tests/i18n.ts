...
const en = {
  ...
  purlResolver: { title: 'PURL Resolver', subtitle: 'Resolve a Package URL to its source code repository', placeholder: 'pkg:pypi/requests', resolve: 'Resolve', resolving: 'Resolving...', noRepoUrl: 'No repository URL found', hideDetails: 'Hide details', showDetails: 'Show details', repoUrl: 'Repository URL', warnings: 'Warnings', foundBy: 'Found by', resolver: 'Resolver' },
  ...
  sbomUpdater: { title: 'SBOM Updater', subtitle: 'Upload a CycloneDX SBOM (JSON) to enrich components with source code repository references', addRow: 'Add row', saved: 'Saved', save: 'Save', process: 'Process', processing: 'Processing SBOM...', downloadEnriched: 'Download enriched SBOM', removeUnresolved: 'Remove unresolved components without subcomponents', ignorePatterns: 'Ignore components matching these criteria:', fieldPlaceholder: 'Field', contains: 'contains', valuePlaceholder: 'Value', total: 'Total', found: 'Found', notFound: 'Not found', skipped: 'Skipped', removed: 'Removed', ignored: 'Ignored', purl: 'PURL', status: 'Status', repoUrl: 'Repository URL', foundBy: 'Found by', resolver: 'Resolver', cancelled: 'Job was cancelled', failed: 'Job failed', queued: 'Waiting to start...' },
  ...
  recentJobs: { title: 'Recent Jobs', empty: 'No recent jobs' },
