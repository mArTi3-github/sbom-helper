...
const en: Record<string, unknown> = {
  ...
  errors: { file_too_large: 'File size exceeds maximum of {max_size_mb} MB', invalid_json: 'Invalid JSON format', invalid_sbom: 'Invalid SBOM file', network_unavailable: 'Network unavailable', invalid_token: 'GitHub token is invalid or expired', token_not_set: 'GitHub token is not set', invalid_update: 'Invalid update request', not_found: 'Not found', purl_not_found: 'PURL not found', invalid_csv: 'Invalid CSV file', invalid_purl: 'Invalid PURL', upstream_error: 'Upstream resolution error', bad_request: 'Bad request', network_error: 'Network error: could not reach the server.', unexpected_error: 'An unexpected error occurred.', unknown_error: 'An unknown error occurred' },
